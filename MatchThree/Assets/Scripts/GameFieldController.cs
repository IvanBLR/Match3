...
public class GameFieldController : MonoBehaviour
{
    ...
    private int[] GetActualNameID()
    {
        ...
        return actualNameID;
    } // done. ¬спомогательный метод

    /// <summary>
    ///  ћетод помогает заполнить пустые €чейки, вернув нужный settingsIndex, оторый гарантирует, что нигде не будет match-3
    /// /// </summary>
...
/* 1. смотрим, где есть свободные €чейки                                                                                 done
   ...
   5. после заполнени€ игрового пол€ нужно не забыть _currentEmptiesCells[,] присвоить значени€ false
 }*/


    /// <summary>
    /// ћетод падени€ элементов. ѕосле очередного падени€ этот метод нужно вызывать снова
    /// </summary>
    ...
    /// <summary>
    /// ¬спомогательный метод. ѕопутно заполн€ет _currentEmptiesCells[,] 
    /// </summary>
    ...
    /// <summary>
    /// метод заполн€ет _currentEmptiesCells[,] нужными значени€ми после каждого падени€ Ёлементов
    /// </summary>
